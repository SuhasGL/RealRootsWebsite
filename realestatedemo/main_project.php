<?php
                        ...
                        if (isset($_SESSION['userName'])) {
                            ...
                            $username = "Guest"; // You can provide a default username
                        }
echo'
<!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container-xxl bg-white p-0">
       ...
       echo' <!-- Navbar Start -->
        <div class="container-fluid nav-bar bg-transparent">';echo "<h3 style='color:green;'>Hello, $username!</h3>";
        echo'
            ...
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5">
                    ';
                        ...
                        echo'<br><br>
                    <h1 class="display-5 animated fadeIn mb-4">Where Dreams find A <span class="text-primary">Home</span> </h1>
                    <p class="animated fadeIn mb-4 pb-2">Discover the ideal residence for your ';echo"family's comfort and uncover the ultimate dwelling place that perfectly suits your family's needs and preferences.</p>
                </div>";echo'
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p>"Explore houses, apartments, condos, and more to find your dream home tailored to your lifestyle and needs".</p>
                </div>
                <div class="row g-4">
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <a class="cat-item d-block bg-light text-center rounded p-3" href="property-type.php">
                            <div class="rounded p-4">
                                <div class="icon mb-3">
                                    <img class="img-fluid" onclick="property-type.php" src="img/icon-apartment.png" alt="Icon">
                                </div>
                                <h6>Apartment</h6>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <p class="mb-4">Unearth the ideal property that matches your aspirations at the top-rated destination for real estate seekers.'; echo" Whether you're in search of a cozy family residence or an investment opportunity, our platform is your go-to resource for finding the perfect property.</p>
                        ";echo'<p><i class=fa fa-check text-primary me-3"></i>One on One Assisstance</p>
                ...
                <div class="bg-light rounded p-3">
                    <div class="bg-white rounded p-4" style="border: 1px dashed rgba(0, 185, 142, .3)">
                        <div class="row g-5 align-items-center">
                            ...
                            <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                                <div class="mb-4">
                                    <h1 class="mb-3">Contact With Our Certified Agents</h1>
                                    <p>Get in Touch with Our Certified Agents.Connect with our trusted and certified agents for expert guidance and assistance.</p>
                                </div>
                                <a href="property-agent.php" class="btn btn-primary py-3 px-4 me-2"><i class="fa fa-phone-alt me-2"></i>Agents Info</a>
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>"Exceptional service! Our agent went above and beyond to find us our dream home.';echo"We couldn't be happier with the result.";echo'"</p>
                    ...
                    <div class="testimonial-item bg-light rounded p-3">
                        <div class="bg-white border rounded p-4">
                            <p>"The ';echo"team's expertise and professionalism made selling our property a breeze. They made the process smooth and stress-free.";echo'"</p>
                            <div class="d-flex align-items-center">
                                <img class="img-fluid flex-shrink-0 rounded" src="img/testimonial-2.jpg" style="width: 45px; height: 45px;">
                                <div class="ps-3">
                                    <h6 class="fw-bold mb-1">Suhas GL</h6>
